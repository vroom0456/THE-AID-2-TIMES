...
export default function App() {
  ...
  // TEMPORARILY DISABLED: Supabase auth check
  // For now, bypass the login gate to access features
  const bypassLogin = true;
  const effectiveUser = bypassLogin ? { id: 'temp-user', email: 'dev@example.com' } : user;

  return (
    <Suspense fallback={<Loader />}>
      <Cursor />

      {!effectiveUser && <LoginGate />}
